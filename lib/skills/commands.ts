...
function showHelp(): string {
  return [
    "── CREATIVE COMMANDS ──",
    "  /story <concept>            Generate a 6-scene story (works with product campaigns too)",
    ...
    "",
    "  /film <concept>             Generate a 4-shot mini-film with camera directions",
    "  /film apply [id]            Generate key frames + animate each to video",
    "  /film/load hifi             HiFi mode: GPT Image 2 → Seedance 2.0 (best for cartoon/anime)",
    "  /film/load <genre>          Load genre (animation, action, noir, scifi, documentary, hifi)",
    "  /film/load auto             Reset to auto-detect genre",
    "  /film skills                List all available film styles",
    "",
    ...
    "",
    "── LIVE STREAM RECIPES ──",
    "  Use 'recipe <name>' in chat when starting a stream:",
    "  classic                     Default (LongLive pipeline)",
    "  ltx-responsive              24fps native, fast prompt response",
    "  ltx-smooth                  48fps (LTX + RIFE interpolation)",
    "  depth-lock                  Preserve depth/structure of input",
    "  scribble-guide              Edge-guided generation",
    "  fast-preview                Quick iteration, fewer denoising steps",
    "  krea-hq                     Highest quality (14B model)",
    "  memflow-consistent          Best character consistency (memory bank)",
    "",
    "── PROJECT MANAGEMENT ──",
    ...
    "  /mix <video> + <audio>     Merge video + audio into one file",
    "    Examples:",
    "    /mix vid-1 + aud-2         Combine video card with audio card",
    "    /mix vid-1,vid-2 + aud-1   Stitch videos then add audio (loops audio to fit)",
    "    /mix vid-1 + aud-1,aud-2   Mix multiple audio tracks onto video",
    "",
    "── TALKING VIDEO ──",
